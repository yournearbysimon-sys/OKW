Locales["en"] = {
    UI = {
        ...
        header= {
          ...
          subTitle= "CUSTOMIZE",
          description=
            "Personalize your character’s look! Choose hairstyles, skin tones, accessories, and more to make your player truly unique.",
            export = 'Export',
            import = 'Import',
            head = 'Head',
            body = 'Body',
        ...
        modal = {
            save = {
                primaryTitle = "PURCHASE",
                noTaxes = "No Taxes",
                secondaryTitle = "CLOTHING",
                description = "Are you absolutely certain you want to purchase this? This action will be irreversible."
            },
            exit = {
                title = "Exit Confirmation",
                description = "Are you sure you want to exit? Any unsaved changes will be lost."
            },
            accept = "Confirm",
            decline = "Cancel"
        },
        ...
        headBlend = {
            title = "Inheritance",
            description = "Change your inheritance",
            shape = {
                title = "Face",
                firstOption = "Father",
                secondOption = "Mother",
        ...
        faceFeatures = {
            title = "Face Features",
            description = "Customize your face features",
        ...
        props = {
            title = "Props",
            description = "Customize your props",
            drawable = "Drawable",
            texture = "Texture",
