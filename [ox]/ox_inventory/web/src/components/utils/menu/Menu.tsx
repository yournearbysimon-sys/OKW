                ...
                <FloatingOverlay lockScroll style={{ zIndex: 99999 }}>
                  <FloatingFocusManager context={context} modal={true} initialFocus={refs.floating}>
                    <div
                      ...
                      className="flex flex-col min-w-[160px] bg-[#1a1a1a] text-gray-300 border border-neutral-800 outline-none rounded-[10px] p-[10px] z-[99999] shadow-2xl"
...
>(({ label, disabled, ...props }, forwardedRef) => {
  ...
  return (
    <button
      ...
      type="button"
      role="menuitem"
      className="outline-none bg-[#262626] hover:bg-[#333333] border border-white/5 rounded-md py-[5px] duration-200 text-center px-4 w-full mb-[6px] text-[13px] font-medium transition-colors last:mb-0"
