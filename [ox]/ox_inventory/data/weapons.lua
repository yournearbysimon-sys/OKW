...
local weaponGroups = {
	...
	Components = categories.weapons,
	Ammo = categories.weapons,
}
...
for groupName, category in pairs(weaponGroups) do
	if weaponData[groupName] then
		for _, item in pairs(weaponData[groupName]) do
